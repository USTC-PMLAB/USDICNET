...
__all__ = ['StrainNet_f', 'U_StrainNet_f', 'U_DICNet', 'U_DICNet2', 'U_DICNet_shape1', 'U_DICNet_shape2', 'U_DICNet_s',
           'U_DICNet_shape2_s']
...
class U_DICNet_model(nn.Module):
    ...
    def __init__(self, U_StrainNet_f_model, batchNorm=True, drop=False):
        ...
        deconv4 = deconv(1026, 256, stride=1, drop=drop)
        deconv2 = deconv(386, 64, stride=1, drop=drop)

        upsampled_flow5_to_4 = nn.ConvTranspose2d(2, 2, 4, 1, 1, bias=False)
        upsampled_flow3_to_2 = nn.ConvTranspose2d(2, 2, 4, 1, 1, bias=False)
...
class U_DICNet_model_shape2(nn.Module):
    ...
    def __init__(self, U_StrainNet_f_model, batchNorm=True, drop=False):
        super(U_DICNet_model_shape2, self).__init__()
        self.model = U_StrainNet_f_model(batchNorm=batchNorm)
        self.batchNorm = batchNorm
        ...
        deconv4 = deconv(1026, 256, stride=1, drop=drop)
        deconv2 = deconv(386, 128, stride=1, drop=drop)
        predict_2 = predict_flow(258, 12)
        upsampled_flow5_to_4 = nn.ConvTranspose2d(2, 2, 4, 1, 1, bias=False)
        upsampled_flow3_to_2 = nn.ConvTranspose2d(2, 2, 4, 1, 1, bias=False)
        self.model.conv1 = conv1
        self.model.conv2 = conv2
        ...
        self.model.upsampled_flow5_to_4 = upsampled_flow5_to_4
        self.model.upsampled_flow3_to_2 = upsampled_flow3_to_2
        self.model.predict_flow2 = predict_2
...
def U_DICNet_shape2(data=None, batchNorm=True, drop=False):
    #loss4-1
